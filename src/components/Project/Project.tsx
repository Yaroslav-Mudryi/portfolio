          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Yaroslav-Mudryi/Gambit_sport_Betting" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Gambit Sports Betting</h3>
              <p>
                Implement User-friendly UI, Integration Payment/third party/payment APIs, Implement single/parlay Betting.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Yaroslav-Mudryi/tarbetz" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                </div>
            </header>
            <div className="body">
              <h3>StarBetz | Sport Betting</h3>
              <p> Developed a serverless betting app using Laravel, Plesk, API Gateway, and MySQL, enabling users to view programming languages, cast bettings, and access details through an interactive UI, leveraging serverless architecture for scalability and cost-efficiency. </p>
            </div>
            <footer> <ul className="tech-list"> <li>Laravel</li> <li>Plesk</li> <li>API Gateway</li> <li>MySQL</li> <li>CronJob</li> </ul> </footer>
          </div>
        </ScrollAnimation>
