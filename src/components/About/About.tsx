    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.1 * 1000}>
          <p>
            Hi there! I'm Yaroslav, an enthusiastic Full stack developer skilled in web, mobile app development, machine learning, and scalable software solutions
          </p>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={400}>
          <div className="education">
            ...
            <p>Ternopil Ivan Pul'uj National Technical University | July 2014 - 2018</p>
            <p>8.09 CGPA</p>
          </div>
        </ScrollAnimation>
